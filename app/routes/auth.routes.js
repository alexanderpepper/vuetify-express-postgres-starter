...
module.exports = app => {
  ...
  app.post('/api/sign-up', [verifySignUp.validateSignUp], controller.signUp)
  app.post('/api/sign-up/validate/credentials', [verifySignUp.validateSignUpCredentials], genericController.validationSuccessResponse)
  app.post('/api/sign-up/validate/password', [verifySignUp.validateSignUpPassword], genericController.validationSuccessResponse)
  app.post('/api/sign-up/validate/security-questions', [verifySignUp.validateSignUpSecurityQuestions], genericController.validationSuccessResponse)
