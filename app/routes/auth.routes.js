...
module.exports = app => {
  ...
  app.post('/api/get-security-questions', [validateSignUp.validateGetSecurityQuestions], controller.getSecurityQuestions)
  ...
  app.post('/api/verify-security-questions', [validateSignUp.validateSignUpSecurityQuestions], controller.verifySecurityQuestions)
  app.post('/api/get-send-options', [validateSignUp.validateGetSendOptions], controller.getSendOptions)
